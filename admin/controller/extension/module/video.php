...
class ControllerExtensionModuleVideo extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('module_video', $this->request->post);		
		...
		if (isset($this->request->post['module_video_status'])) {
			$data['module_video_status'] = $this->request->post['module_video_status'];
		} elseif ($this->config->get('module_video_status')) { 
			$data['module_video_status'] = $this->config->get('module_video_status');
		}	
