...
class ControllerExtensionModuleOcmegamenu extends Controller
{
    ...
    public function index() {
        $data = $this->load->language('extension/module/ocmegamenu');
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/ocmegamenu', 'token=' . $this->session->data['token'], true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/ocmegamenu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true)
            );
        }

        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/ocmegamenu', 'token=' . $this->session->data['token'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/ocmegamenu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
        }

        $data['menu_editor_link'] = $this->url->link('extension/module/ocmegamenu/menulist', 'token=' . $this->session->data['token'], true);
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('extension/module/ocmegamenu/menuList', 'token=' . $this->session->data['token'] . $url, true));
        }
    ...
    public function getlist() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/ocmegamenu/menuList', 'token=' . $this->session->data['token'] . $url, true)
        );

        $data['add'] = $this->url->link('extension/module/ocmegamenu/add', 'token=' . $this->session->data['token'] . $url, true);
        $data['delete'] = $this->url->link('extension/module/ocmegamenu/delete', 'token=' . $this->session->data['token'] . $url, true);
        ...
        if($menus) {
            foreach ($menus as $menu) {
                $data['menu_list'][] = array(
                    ...
                    'url'       => $this->url->link('extension/module/ocmegamenu/edit', 'token=' . $this->session->data['token'] . '&menu_id=' . $menu['menu_id'] . $url, true)
                );
            }
        }
        ...
        $pagination->url = $this->url->link('extension/module/ocmegamenu/menuList', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    public function getForm() {
        ...
        if (!isset($this->request->get['menu_id'])) {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/add', 'token=' . $this->session->data['token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/edit', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'] . $url, true);
        }

        if (!isset($this->request->get['menu_id'])) {
            $this->model_extension_module_ocmegamenu->deleteTopItemByMenu('0');
            $data['cancel'] = $this->url->link('extension/module/ocmegamenu/menuList', 'token=' . $this->session->data['token'] . $url, true);
        } else {
            $data['cancel'] = $this->url->link('extension/module/ocmegamenu/menuList', 'token=' . $this->session->data['token'] . $url, true);
        }
        ...
        if (isset($this->request->get['menu_id'])) {
            ...
            foreach ($results as $result) {
                ...
                if($sub_items_lv2) {
                    foreach ($sub_items_lv2 as $item) {
                        ...
                        if($sub_items_lv3) {
                            foreach ($sub_items_lv3 as $s_item) {
                                $sub_items3[] = array(
                                    ...
                                    'url'           => $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $s_item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                                    'del_url'       => $this->url->link('extension/module/ocmegamenu/deleteSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $s_item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                                );
                            }
                        }
                        ...
                        $sub_items2[] = array(
                            ...
                            'url'           => $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                            'del_url'       => $this->url->link('extension/module/ocmegamenu/deleteSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                        );
                    }
                }
                ...
                $data['top_items'][] = array(
                    ...
                    'url'           => $this->url->link('extension/module/ocmegamenu/editTopItem', 'token=' . $this->session->data['token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                    'del_url'       => $this->url->link('extension/module/ocmegamenu/deleteTopItem', 'token=' . $this->session->data['token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                );
            }
        }

        if (isset($this->request->get['menu_id'])) {
            $data['top_items_form_url'] = $this->url->link('extension/module/ocmegamenu/addTopItem', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_add_form_url'] = $this->url->link('extension/module/ocmegamenu/addSubItem', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['multiple_del_url'] = $this->url->link('extension/module/ocmegamenu/deleteMultipleItems', 'token=' . $this->session->data['token'] . '&menu_id=' . $this->request->get['menu_id'], true);
        } else {
            $data['top_items_form_url'] = $this->url->link('extension/module/ocmegamenu/addTopItem', 'token=' . $this->session->data['token'], true);
            $data['sub_item_add_form_url'] = $this->url->link('extension/module/ocmegamenu/addSubItem', 'token=' . $this->session->data['token'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'], true);
            $data['multiple_del_url'] = $this->url->link('extension/module/ocmegamenu/deleteMultipleItems', 'token=' . $this->session->data['token'], true);
        }

        $data['get_top_items_url'] = $this->url->link('extension/module/ocmegamenu/getTopItemsByAjax', 'token=' . $this->session->data['token'], true);
        ...
        if($results) {
            ...
            foreach ($results as $result) {
                ...
                if($sub_items_lv2) {
                    foreach ($sub_items_lv2 as $item) {
                        ...
                        $sub_items2[] = array(
                            ...
                            'name'      => $item['name'],
                            'position'  => $item['position'],
                            'url'           => $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true),
                            'del_url'       => $this->url->link('extension/module/ocmegamenu/deleteSubItem', 'token=' . $this->session->data['token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true)
                        );
                    }
                }
                ...
                $json['top_items'][] = array(
                    ...
                    'name'          => $result['name'],
                    'position'      => $result['position'],
                    'url'           => $this->url->link('extension/module/ocmegamenu/editTopItem', 'token=' . $this->session->data['token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true),
                    'del_url'       => $this->url->link('extension/module/ocmegamenu/deleteTopItem', 'token=' . $this->session->data['token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true)
                );
            }
        }
    ...
    public function getTopItemForm($menu_id) {
        ...
        $data['append_categories_link'] = $this->url->link('extension/module/ocmegamenu/appendChildCategories', 'token=' . $this->session->data['token'], true);
        ...
        if(!isset($this->request->get['menu_item_id'])) {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/addTopItem', 'token=' . $this->session->data['token'] . '&menu_id=' . $menu_id, true);
        } else {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/editTopItem', 'token=' . $this->session->data['token'] . '&menu_item_id=' . $this->request->get['menu_item_id'] . '&menu_id=' . $menu_id, true);
        }
    ...
    public function getSubItemForm($menu_id) {
        ...
        if(!isset($this->request->get['sub_item_id'])) {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/addSubItem', 'token=' . $this->session->data['token'] . '&parent_id=' . $this->request->get['parent_id'] . '&level=' . $this->request->get['level'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/ocmegamenu/editSubItem', 'token=' . $this->session->data['token'] . '&sub_item_id=' . $this->request->get['sub_item_id'], true);
        }
