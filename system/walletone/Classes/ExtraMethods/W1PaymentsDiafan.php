...
class W1PaymentsDiafan extends \WalletOne\Classes\StandardsMethods\W1Payments  {
  public $orderIdReal = '';
      
  function __construct($config, $params = array(), $nameCms = '') {
    parent:: __construct($config, $params = array(), $nameCms = '');
  ...
  public function createFormArray($settings, $invoce){
    ...
    $fields['orderIdReal'] = $this->orderIdReal;
