		      ...
		      <div class="row">
	            ...
	            <div class="col-sm-4">
	              <div class="form-group">
	                ...
	                <input type="text" name="filter_xml" value="<?php echo htmlspecialchars($filter_xml); ?>" placeholder="<?php echo $entry_xml; ?>" id="input-xml" class="form-control" />
	              </div>
	            </div>
	            <div class="col-sm-12">
	              <div class="btn-group pull-right">
		            ...
		            <?php if (!empty($filter_name) || !empty($filter_author) || !empty($filter_xml)) { ?><a href="<?php echo $reset_url; ?>" id="button-filter" class="btn btn-danger" data-toggle="tooltip" title="<?php echo $button_reset; ?>"><i class="fa fa-times"></i></a><?php } ?>
		          </div>
	            </div>
	          </div>
	        </form>
